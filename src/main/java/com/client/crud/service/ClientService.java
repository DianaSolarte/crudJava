...
public class ClientService implements IServiceClient {
    ...
    public ResponseEntity<?> delete(Long id){
        ...
        if(client == null){
            return new ResponseEntity<>("No existe el cliente seleccionado", HttpStatus.NOT_FOUND);
        }

        clientRepository.deleteById(id);
        return new ResponseEntity<>("Se elimino exitosamente "+ client.getName(), HttpStatus.OK);
